<footer class="page-footer">
	...
	<div class="footer-nav">
		<div class="container clearfix">
			...
			<div class="footer-nav__col footer-nav__col--contacts">
				...
				GMRIT, dolpeta, Rajam<br>
				Andhra pradesh, 532127
			</address>
				<div class="phone">
					Telephone:
					<a class="phone__number" href="tel:0123456789">9874563210</a>
				</div>
				<div class="email">
					Email:
					<a href="mailto:support@yourwebsite.com" class="email__addr">gmrfashion@gmail.com</a>
				</div>
			</div>
	...
	<div class="page-footer__subline">
		<div class="container clearfix">
			...
			<div class="copyright">
				<P>&copy; 2024 GMR fashion;</p>
			</div>

			<div class="developer">
				<p>Developed by code-commanders(intexm)</p>
			</div>
		</div>
	</div>
</footer>
