...
<?php
if(!isset($_SESSION['customer_email'])){
  echo '<a href="admin_area/index.php?dashboard" class="login__link">Admin</a>';
} 
  else
  { 
      echo '<a href="customer/my_account.php?my_orders" class="login__link">My Account</a>';
      ...
      <div class="container clearfix">
        ...
        <div class="logo">
          <a class="logo__link" href="index.php">
            <img class="logo__img" src="images/logo2.png" alt="Avenue fashion logotype" width="237" height="19" >
          </a>
        </div>
